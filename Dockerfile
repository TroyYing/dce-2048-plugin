...
LABEL maintainer="Kay Yan" \
      ...
      io.daocloud.dce.plugin.vender="DaoCloud" \
      io.daocloud.dce.plugin.validation-dce-version=">=2.2.0" \
      io.daocloud.dce.plugin.nano_cpus_limit="500000000" \ # 0.5 核
      io.daocloud.dce.plugin.memory_bytes_limit="52428800" # 50 MB
